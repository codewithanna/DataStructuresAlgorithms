...
import main.BubbleSortOptSecond;
import org.junit.jupiter.api.BeforeAll;
import org.junit.jupiter.api.Test;

class BubbleSortOptSecondTest {

    private static BubbleSortOptSecond bubbleSortInstance;


    @BeforeAll
    static void setUpBeforeClass() throws Exception {
        bubbleSortInstance = new BubbleSortOptSecond();
    }
    ...
    void testFiveElementsArray() {
        ...
        int[] result = bubbleSortInstance.bubbleSortOptSecond(fiveElementsArray);
    ...
    void testFifteenElementsArray() {
        ...
        int[] result = bubbleSortInstance.bubbleSortOptSecond(fifteenElementsArray);
    ...
    void testDuplicateValueArray() {
        ...
        int[] result = bubbleSortInstance.bubbleSortOptSecond(duplicateValueArray);
