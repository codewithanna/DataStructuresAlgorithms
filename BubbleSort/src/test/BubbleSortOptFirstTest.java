...
import main.BubbleSortOptFirst;
import org.junit.jupiter.api.BeforeAll;
import org.junit.jupiter.api.Test;

class BubbleSortOptFirstTest {

    private static BubbleSortOptFirst bubbleSortInstance;


    @BeforeAll
    static void setUpBeforeClass() throws Exception {
        bubbleSortInstance = new BubbleSortOptFirst();
    }
    ...
    void testFiveElementsArray() {
        ...
        int[] result = bubbleSortInstance.bubbleSortOptFirst(fiveElementsArray);
    ...
    void testFifteenElementsArray() {
        ...
        int[] result = bubbleSortInstance.bubbleSortOptFirst(fifteenElementsArray);
    ...
    void testDuplicateValueArray() {
        ...
        int[] result = bubbleSortInstance.bubbleSortOptFirst(duplicateValueArray);
