...
public class TreePreOrderTraversalTest {
    ...
    ROOT, LEFT, RIGHT
    1, 2, 4, 7, 8, 5, 9, 10, 3, 6, 11, 12, 5, 13, 14

    */

    ArrayList<Integer> resultSmallTree = new ArrayList<>(Arrays.asList(1, 2, 4, 3, 5));
    TreePreOrderTraversal treeSmall = new TreePreOrderTraversal();;
    ArrayList<Integer> resultLargeTree = new ArrayList<>(Arrays.asList(1, 2, 4, 7, 8, 5, 9, 10, 3, 6, 11, 12, 5, 13, 14));
    TreePreOrderTraversal treeLarge = new TreePreOrderTraversal();;
    ...
    @Test
    public void preOrderTraverseSmallTreeTest() {
    assertEquals(resultSmallTree.toString(), treeSmall.printPreOrder().toString());
    }

    @Test
    public void preOrderTraverseLargeTreeTest() {
    assertEquals(resultLargeTree.toString(), treeLarge.printPreOrder().toString());
    }
